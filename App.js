...
const restaurantList = [
  {
    ...
    "data": {
      ...
      "thirdPartyVendor": "",
      "adTrackingID": "cid=5687240~p=1~eid=00000185-912b-58df-1726-03520025011e",
      "badges": {
        "imageBased": [
  ...
  },
  {
    ...
    "data": {
      ...
      "id": "254192",
      "name": "McDonald's",
      "uuid": "63ea8976-60d8-428d-8627-001bcd56311f",
      "city": "4",
      "area": "Rohini",
      "totalRatingsString": "1000+ ratings",
      "cloudinaryImageId": "qyher0qn2mkogbmta2cr",
      "cuisines": [
        "American"
      ],
      "tags": [
  ...
  },
  {
    ...
    "data": {
      ...
      "id": "336053",
      "name": "Wendy's",
      "uuid": "51a56773-ce0d-45fa-8276-582a28bffa2f",
      "city": "4",
      "area": "Rohini",
      "totalRatingsString": "500+ ratings",
      "cloudinaryImageId": "trp5sg5d6b36fts1z3lp",
      "cuisines": [
        "American",
        "Burgers",
        "Fast Food",
      ...
      "cityState": "4",
      "address": "Plot 8, Ground Floor, Sachdeva Tower Sector 8, Rohini, New Delhi 110085",
      "locality": "Sector 8",
      "parentId": 972,
      "unserviceable": false,
      "veg": false,
      ...
      "thirdPartyAddress": false,
      "thirdPartyVendor": "",
      "adTrackingID": "cid=5700570~p=4~eid=00000185-912b-58df-1726-03530025041b",
      "badges": {
        "imageBased": [
...

  {
    ...
    "data": {
      ...
      "uuid": "0e3b6137-5430-4398-92d6-29c104c1e14f",
      "city": "4",
      "area": "Sector    3",
  ...
  },
  {
    ...
    "data": {
      ...
      "id": "498382",
      "name": "Burger King",
      "uuid": "a31d7e18-7349-406f-937a-5e6c279feafc",
      "city": "4",
      "area": "Rohini",
      "totalRatingsString": "500+ ratings",
  ...
  },
  {
    ...
    "data": {
      ...
      "id": "10392",
      "name": "Subway",
      "uuid": "b8f9388f-7837-4c42-8e9d-54f628414e90",
      "city": "4",
      "area": "Sector 3, Rohini",
      "totalRatingsString": "100+ ratings",
      "cloudinaryImageId": "bloy3kebf7lmz6ejxwgu",
      "cuisines": [
        "Fast Food",
        "Salads",
        "Snacks",
      ...
      "slugs": {
        "restaurant": "subway-rohini",
        "city": "delhi"
      },
      "cityState": "4",
      "address": "M2K Mall, Near M2K Theatre, Rohini Sec 3",
      "locality": "Sector 3",
      "parentId": 2,
      "unserviceable": false,
      "veg": false,
      ...
      "thirdPartyAddress": false,
      "thirdPartyVendor": "",
      "adTrackingID": "cid=5693604~p=7~eid=00000185-912b-58df-1726-035400250703",
      "badges": {
        "imageBased": [
...
const RestaurantCard = ({ name, cuisines, lastMileTravelString, cloudinaryImageId }) => {
  ...
  return (
    <div className="card">
      <img classname="card-image" alt="logo" src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/" + cloudinaryImageId} />
      <h2>{name}</h2>
      <h5>{cuisines.join(',')}</h5>
